...
export default function FormResponse() {
    ...
    async function loadForm() {
        try {
            ...
            console.log('Form loaded with fields:', generalData);
            console.log('Form loaded with fields:', categoryData);
                ...
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <div className="mb-8">
                        ...
                        <div className="space-y-2">
                            {general.map((item, idx) => (
                                <a href={`/general/forms/${item.id || idx}`} key={item.id || idx} className='bg-[#E6B372] hover:bg-gray-200 p-4 rounded-lg cursor-pointer flex items-center justify-between transition-colors'>
                                    <div>
                    ...
                    <div className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 z-40">
                        <div className="max-w-2xl mx-auto px-4 py-4 flex gap-4 justify-between">
                            <a href='#' className="bg-gray-300 hover:bg-gray-400 text-gray-700 px-8 py-3 rounded-lg font-medium transition-colors">
                                一時保存する
                            </a>
