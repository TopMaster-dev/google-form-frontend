            ...
            <div className="col-span-6">
                <div className="bg-white p-4 rounded shadow space-y-4">
                    ...
                    <div className="flex gap-2 flex-wrap">
                        ...
                        <button onClick={() => addQuestion('checkboxes')} className="px-3 py-1 border rounded text-sm">チェックボックス</button>
                        <button onClick={() => addQuestion('dropdown')} className="px-3 py-1 border rounded text-sm">ドロップダウン</button>
